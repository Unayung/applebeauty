...
role :web, "applebeauty.com"                          # Your HTTP server, Apache/etc
role :app, "applebeauty.com"                         # This may be the same as your `Web` server
role :db,  "applebeauty.com"   , :primary => true # This is where Rails migrations will run
